...
function ProjectItem() {
  ...
  return (
    <div ref={intersectionRef} className="min-h-[150vh]">
              ...
              <div className="relative space-y-6 md:top-0 md:left-0 md:space-y-8 lg:w-2/3">
                ...
                <div className="mx-12 md:mx-0 space-y-3 md:space-y-5 text-left">
                  <p className="text-xs sm:text-sm md:text-base">
                    A project i worked on to tackle Firebase OAuth and designed
                    custom hooks and page directions dinamically on SSR pages
                    experimentetd with DOM
                  </p>
                  <div>
                    <p className="text-xs sm:text-sm md:text-base">
          ...
          >
            <div className="row translateEven">
              <div className="z-20 relative space-y-6 md:top-0 md:left-0 md:space-y-8 lg:w-2/3">
                ...
                <div className="mx-12 md:mx-0 space-y-3 md:space-y-5 text-left">
                  <p className="text-xs sm:text-sm md:text-base">
                    In this project I worked on React Context to design shopping
                    cart. Designed reducer functions and form component. Items
                    fetched from Firebase orders posted back.
                  </p>
                  <div>
                    <p className="text-xs sm:text-sm md:text-base">
